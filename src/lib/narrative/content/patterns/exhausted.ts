...
The other signature of this pattern is that nothing seems to work anymore. Melatonin helped for a week, then stopped. The sleep hygiene changes made no difference. Exercise does not tire you out the way it used to — or worse, it wires you up. You have probably tried five or ten things that work for other people and concluded that you are somehow uniquely broken. You are not broken. You are depleted. And depleted systems do not respond to optimization. They respond to restoration.`,

		secondary: `There is also a depletion layer here — your system has been running under sustained load for long enough that its recovery capacity is diminished. Sleep that should be restorative is not fully restoring you, because the stress-response system has lost its normal rhythm. This means that even as other patterns improve, you may still feel unrested until the deeper energy reserves start to rebuild.`
	},
...
Exercise is another one that cuts both ways. For a healthy system, exercise is a net positive for sleep. For a depleted system, intense exercise is another stressor — another withdrawal from an already empty account. If you are doing high-intensity workouts and feeling worse afterward instead of better, that is your body telling you the dose is too high for your current capacity. It is not that exercise is bad. It is that your system cannot afford the recovery cost right now.

Stimulants — caffeine, energy drinks, pre-workout — are keeping the illusion going. They are masking the signals that would otherwise force you to rest. They are also raising your baseline cortisol, which further flattens the rhythm you need for restorative sleep. You are borrowing alertness from tomorrow to function today.

{{habit_details}}

The deepest part of this loop is psychological: you have likely built your identity, your work, and your relationships around being the person who powers through. The idea of deliberately doing less — of resting before you have earned it, of scaling back when things need doing — feels like failure. That belief is the engine that keeps the depletion running.`,
	...
	suggestions: {
		framing: `I need you to hear this clearly: your body does not need more optimization right now. It needs less demand. The instinct that got you here — the drive to push harder, do more, find the right hack — is the very thing that is keeping you stuck. The prescription for this pattern is counterintuitive and uncomfortable: strategic, deliberate rest. Not as a reward for productivity. As a medical intervention.`
	},
...
{{honest_chronicity}} The first thing that will change is not your sleep — it is your energy during the day. You will notice that the afternoon crashes become less severe, that you can think a little more clearly by mid-morning, that the heavy feeling lifts a little sooner after waking. That is the cortisol rhythm starting to re-establish itself. Sleep quality follows, usually by 2-4 weeks. Deep sleep increases first. Then sleep continuity improves. Then morning restedness returns. It is a cascade, and it starts slow.

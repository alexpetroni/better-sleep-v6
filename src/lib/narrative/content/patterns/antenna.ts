...
export const antenna: PatternContent = {
	whereYouAre: {
		primary: `Alright, let me explain what is happening, because this one is easy to misunderstand — and people have probably been telling you the wrong things about it for years.

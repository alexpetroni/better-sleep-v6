...
export const recommendationProse: Record<string, string> = {
	...
	neuro_evaluation:
		'Consulta un neurolog legat de comportamentul de actare a viselor. A actiona fizic visele (sa lovesti, sa dai cu piciorul, sa cazi din pat) e o conditie specifica numita tulburare de comportament in somnul REM. Necesita evaluare profesionala atat pentru siguranta ta cat si pentru ca poate fi un marker timpuriu pentru alte conditii neurologice.',

	stimulus_control:
		'Rupe asocierea pat-stare de veghe. Concret: patul e doar pentru somn si intimitate. Daca nu adormi in 20 de minute, ridica-te. Mergi in alta camera. Fa ceva plictisitor in lumina slaba. Intoarce-te cand te simti somnoros. Stiu, pare contraintuitiv cand esti epuizat. Dar acum creierul tau a invatat ca pat inseamna frustrare si efort. Trebuie sa reantrenezi acea asociere, si singurul mod e sa incetezi sa o mai intaresti pe cea veche.',
	...
	environment_temp:
		'Regleaza temperatura. Tinteste 18-20 grade C. Temperatura centrala a corpului trebuie sa scada pentru a initia somnul. Daca camera e prea calda, corpul tau nu poate completa acea cascada termica. O camera mai rece cu suficiente paturi ca sa te simti confortabil, asta e tinta.',
	...
	mental_health_support:
		'Ia in considerare sa te conectezi cu un terapeut, in mod specific unul instruit in CBT-I (terapie cognitiv-comportamentala pentru insomnie). Daca scorurile de dispozitie si anxietate raman ridicate, cineva care sa le poata adresa pe amandoua. Nu e o recomandare de slabiciune. E o recunoastere ca dimensiunea emotionala e un factor principal aici, si suportul specializat va accelera tot restul.',

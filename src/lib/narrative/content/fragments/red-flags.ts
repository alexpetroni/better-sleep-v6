...
export const redFlagWarnings: Record<string, string> = {
	...
	rbd:
		'The dream enactment you described, physically acting out dreams, moving, falling out of bed, that needs neurological evaluation. This is a specific condition called REM sleep behavior disorder. It is manageable, but it needs professional assessment for your immediate safety and because it can be associated with other conditions that benefit from early monitoring.',

	severe_insomnia:
		'Your insomnia severity scores are in the clinical range. I want to be direct: this is treatable. CBT-I (cognitive behavioral therapy for insomnia) has the strongest evidence base of any insomnia intervention, stronger even than medication, and the results last. I would strongly encourage connecting with a sleep specialist or psychologist trained in CBT-I.',

	depression:
		'Your mood screening scores suggest depression may be a significant factor here. Sleep and mood are deeply bidirectional. Poor sleep worsens mood, and depression disrupts sleep architecture. Addressing both at the same time produces better outcomes than tackling either alone. A mental health professional can help determine whether treatment for depression should run alongside the sleep interventions.',
